<%@ page pageEncoding="UTF-8" contentType="text/html; charset=UTF-8"%> 
  ...
  <!-- scripts -->
        <script src="https://apis.google.com/js/client.js?onload=init"  async defer></script>
        
        <script src="https://code.jquery.com/jquery-2.1.3.min.js"></script>
        <script src="/meeing/js/app.js"  type="text/javascript" ></script>
        <script src="/meeting/js/auth.js"  type="text/javascript" ></script>
...
<html lang="en">
    <head>		
        ...
        <link rel="stylesheet" href="/meeting/css/style.css" type="text/css">
     <style>   
          #video {
      width: 500px;
      height: 250px;
