  ...
  div p {
	...
	<script type="text/javascript">
		...
		function fncGetPageList(currentPage) {
			...
			$("form").attr("method" , "POST").attr("action" , "/activity/listMyInterest").submit();
		}
   ...
   <div class="block-schedule overlay site-section" style="background-image: url('/resources/images/img_4.jpg');">
      ...
      <div class="container mb-3">
        ...
        <div class="col-md-7 text-left text-primary">
          ...
          <li class="nav-item">
            <a class="nav-link active" id="pills-tuesday-tab" data-toggle="pill" href="#pills-tuesday" role="tab" aria-controls="pills-tuesday" aria-selected="true">관심 게시물</a>
          </li>
          <li class="nav-item">
