		...
		var selfClose = 1;
		 ...
		 $( function() {
				...
				$("#kakao_login").on("click" , function() {
					...
					popWin 
					= window.open("https://kauth.kakao.com/oauth/authorize?client_id=11723e59094c12e0f6ad95a132887387&redirect_uri=http://192.168.0.39:8080/user/kakaoLogin&response_type=code",
												"popWin", 
												"left=300,top=200,width=780,height=130,marginwidth=0,marginheight=0,"+
												"scrollbars=no,scrolling=no,menubar=no,resizable=no"); 
