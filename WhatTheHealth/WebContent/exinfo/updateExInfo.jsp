...
<script type="text/javascript">
	...
	function fncUpdateExInfo(){
		...
		$("form[name=communityPost]").attr("method","POST").attr("action","/exInfo/updateExInfo").submit();	
	}
...
<form name="communityPost">
	...
	<div class="site-section bg-light">
      <div class="container">
       <h4 class="info-title margin-five no-margin-top">운동꿀팁 게시글 수정하기</h4>
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-1 mb-5 mb-md-0">
              	    <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#mapModal">
