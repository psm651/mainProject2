...
<title>Daum 맵시작하기</title>
   ...
   #line{position:absolute; margin-top:-500px; z-index:1; margin-left:1400px;}
   </style>
...
function displayPlaces(places) {
   ...
   for ( var i=0; i<places.length; i++ ) {
       ...
       })(marker, places[i].place_name, map);
...
function getTimeHTML(distance) {
   ...
   content +=   '<div class="custom-control custom-radio">'+
               ...
               '<label class="custom-control-label" for="jb-radio-2">걷기</label>'+
            '</div>';
   content +=   '<div class="custom-control custom-radio">'+
               '<input type="radio" name="jb-radio" id="jb-radio-2" class="custom-control-input">'+
               '<label class="custom-control-label" for="jb-radio-2">달리기</label>'+
            '</div>';   
   content +=   '<div class="custom-control custom-radio">'+
               '<input type="radio" name="jb-radio" id="jb-radio-2" class="custom-control-input">'+
               '<label class="custom-control-label" for="jb-radio-2">자전거</label>'+
            '</div>';               
