             ...
             list.forEach(function(item, index, array){     
                  ...
                  if(item["photo"]==null){
             		 ...
             		 if(youtube!=-1){
            	  	 ...
            	  	 appen += '<img src="/resources/images/upload/'+item["photo"]+'" class="img-fluid" width= "348px" height= "200;">';  
            	  }
              	}
                  ...
                  appen += '<span class="text-uppercase date d-block mb-3"><small>'+item["postDate"]+'</span>';
   ...
   <div class="site-wrap">
    ...
    <div class="site-section">
      ...
      <hr/>
        ...
        <p align="right"><a href="#" align="right" id="addExCom" class="btn btn-primary pill text-white px-4">글쓰기</a></p>
        <br/>
	                	...
	                	<c:if test="${!empty post.photo}">
		               		<c:choose>
		               			<c:when test="${fn:contains(youtubeThumbnail,'https')}">
		               				<img src="${post.photo}" class="img-fluid" width= "348;" height= "200;" >
		               			</c:when>   
		               			<c:otherwise>
		               				<img src="/resources/images/upload/${post.photo}"  class="img-fluid" width= "348;" height= "200;">
		               			</c:otherwise>            			
		               		</c:choose>
	                	</c:if>
              		</div>
